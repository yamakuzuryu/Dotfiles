#=========================================#
# Yamakuzuryu ZSH Oh My ZSH Configuration #
#=========================================#
...
# In case of error: Error: EMFILE: too many open files, watch at FSEvent.FSWatcher._handle.onchange
# set NODE_OPTIONS=--max_old_space_size=8172
# Create a file at /etc/security/limits.conf
